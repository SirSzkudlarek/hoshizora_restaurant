  ...
  return (
    <header className='hoshizora__header bg_sky-gradient hoshizora__wrapper section__padding' ref={parallaxRef}>
      <div className='hoshizora__header-introduction'>
        ...
        <p className="p__kaisei-tokumin" style={{ margin: '2rem 0' }}>Sit tellus lobortis sed senectus vivamus molestie. Condimentum volutpat morbi facilisis quam scelerisque sapien. Et, penatibus aliquam amet tellus </p>
      ...
      <MouseParallax strength={0.10}  isAbsolutelyPositioned >
